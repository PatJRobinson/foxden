  ...
  outputs = {
    ...
    in {
      packages.default = pkgs.buildGoModule {
        ...
        # If your main package is under ./cmd/news-tui
        subPackages = ["cmd/news-tui"];
      ...
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "news-tui Go dev shell"
          echo
          echo "Useful commands:"
          echo "  go mod init github.com/patjrobinson/news-tui"
